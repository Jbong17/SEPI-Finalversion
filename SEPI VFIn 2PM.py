...
""")
    ...
    pdf.section_body(f"""
Parent Name: {data['parent_name']}  |  Age: {data['parent_age']}  |  Nationality: {data['parent_nationality']}  |  Religion: {data['parent_religion']}
Contact: {data['parent_contact']}  |  Education: {data['parent_education']}  |  Employment: {data['parent_employment']}
""")
...
"""))
    pdf.ln(8)
    pdf.cell(0, 5, "Signature of Parent/Guardian/Authorized Representative: _____________________________", ln=True)
