...
st.title("📄 Enrollment Form Generator")
...
class StyledPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 10, "SCHOOL OF EVERLASTING PEARL, INC.", ln=True, align="C")
        self.set_font("Arial", "", 10)
        self.cell(0, 5, "#066 Sitio Suuga Village – Phase III, Marcos Highway, Mambugan, Antipolo City 1870", ln=True, align="C")
        self.cell(0, 5, "Email: sepi402954@gmail.com | sepiregistrar@gmail.com", ln=True, align="C")
        self.cell(0, 5, "DepEd School ID No.: 402954 | ESC School ID No.: 403694", ln=True, align="C")
        self.cell(0, 5, "Government Recognition Nos.: K-042 s.2009 | E-041 s.2012 | 026 s.2011", ln=True, align="C")
        self.ln(5)
        self.set_font("Arial", "B", 12)
        self.cell(0, 10, "ENROLLMENT FORM", ln=True, align="C")
        self.ln(5)
